...
export default function CourtCard({ imageUrl, name, sport, price, rating }: CourtCardProps) {
  return (
    /* Glavni kontejner kartice: moderni stakleni izgled (backdrop-blur), 
       zaobljene ivice (rounded-2xl) i senka (shadow-xl) sa hover animacijom 
    */
    <div className="max-w-sm w-full bg-zinc-900/40 backdrop-blur-md rounded-2xl border border-zinc-800/50 overflow-hidden shadow-xl hover:shadow-emerald-500/5 hover:-translate-y-1 transition-all duration-300 flex flex-col">
      ...
      <div className="relative h-48 w-full bg-zinc-800">
        <Image
          ...
          priority={false}
        />
        {/*bedž za sport u gornjem levom uglu */}
      ...
      {/*dole Informacije o terenu */}
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        <div>
          {/* Naziv terena */}
          <h3 className="text-lg font-bold text-zinc-100 tracking-tight line-clamp-1">
            {name}
          </h3>
